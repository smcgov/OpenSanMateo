...
// echo 'attempted to create working directory: ' . $this->working_directory; die;
    
    // Check if writable
    if (!is_writeable($this->working_base_directory))
    {
// die("Error creating working directory '".$this->working_directory."'");
...
// echo ("Resumption was not enalbled, call enableResumption() before calling the resume()-method!"); die;
    ...
    {
// echo ("Couldn't find any previous aborted crawling-process with crawler-id '".$this->crawler_uniqid."'"); die;
